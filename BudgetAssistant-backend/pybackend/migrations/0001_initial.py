# Generated by Django 5.1.2 on 2025-07-08 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.CharEnumField(enum={'base': 'enumfields.enums.ChoicesEnum', 'choices': {'BOTH': {'initial': True, 'value': 'BOTH'}, 'EXPENSES': {'initial': True, 'value': 'EXPENSES'}, 'REVENUE': {'initial': True, 'value': 'REVENUE'}}, 'name': 'TransactionTypeEnum', 'type': str}, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_timestamp', models.DateTimeField(default=datetime.datetime(2025, 7, 8, 16, 35, 54, 704387))),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['alias'], name='pybackend_b_alias_cf5da3_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['name'], name='pybackend_c_name_b3389e_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['qualified_name'], name='pybackend_c_qualifi_06ee82_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['is_root'], name='pybackend_c_is_root_23a94a_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['type'], name='pybackend_c_type_6657af_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['name', 'type'], name='pybackend_c_name_e1dee6_idx'),
        ),
        migrations.AddIndex(
            model_name='budgettreenode',
            index=models.Index(fields=['amount'], name='pybackend_b_amount_53b77e_idx'),
        ),
        migrations.AddIndex(
            model_name='budgettreenode',
            index=models.Index(fields=['category', 'amount'], name='pybackend_b_categor_7e64ac_idx'),
        ),
        migrations.AddIndex(
            model_name='counterparty',
            index=models.Index(fields=['account_number'], name='pybackend_c_account_34fcaf_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['booking_date'], name='pybackend_t_booking_28a352_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['amount'], name='pybackend_t_amount_9cab4e_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['currency'], name='pybackend_t_currenc_a07514_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['country_code'], name='pybackend_t_country_c5d132_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['upload_timestamp'], name='pybackend_t_upload__212057_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['booking_date', 'amount'], name='pybackend_t_booking_1a3ea8_idx'),
        ),
    ]
