...
@Component({
    selector: 'app-transactions0',
    templateUrl: './transactions0.component.html',
    styleUrls: ['./transactions0.component.scss'],
    standalone: true,
...
export class Transactions0Component implements OnInit, AfterViewInit {
